 ...
 * @author Owen Astrahcna 2024
 */
public class Chat201Test {
    ...
    public void testSimpleKgram() {
        ...
        AbstractMarkovModel markov = getModel(2);
        markov.setTraining(training);
        String output = "";
        //while (output.length() < 15) {
        //    output = markov.getRandomText(100);
        //}
        output = Chat201Driver.getRandomText(500,markov);
    ...
    public void testMapAllRepeats() {
        ...
        for (int k = 1; k <= maxOrder; k++) {
            AbstractMarkovModel markov = getModel(1);
            markov.setTraining(testString);
            String output = Chat201Driver.getRandomText(length / 5,markov);
